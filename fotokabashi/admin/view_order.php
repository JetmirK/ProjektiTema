                    ...
                    <div id="main-wrapper">
                        ...
                        <div class="left-sidebar">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="all_fotograf.php">Te gjith Fotografet</a></li>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">Shiko Reservimin</h4>
                                                </div>
